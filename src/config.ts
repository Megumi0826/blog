...
export const siteConfig: SiteConfig = {
	title: "Megumi0826の小破站",
	subtitle: "",
	siteURL: "https://www.megumi.xin/", // 请替换为你的站点URL，以斜杠结尾
	...
	bangumi: {
		userId: "1195428", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/Megumi0826",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/108015151",
					external: true,
					icon: "fa6-brands:bilibili",
				},
				{
					name: "Steam",
					url: "https://steamcommunity.com/profiles/76561198923528548/",
					external: true,
					icon: "mdi:steam",
				},
			],
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://www.megumi.xin/twikoo",
		lang: SITE_LANG,
	},
};
